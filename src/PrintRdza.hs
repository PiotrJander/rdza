...
instance Print TopDef where
  prt i e = case e of
    FnDef id args returntype block -> prPrec i 0 (concatD [doc (showString "fn"), prt 0 id, doc (showString "("), prt 0 args, doc (showString ")"), prt 0 returntype, prt 0 block])
  prtList _ [x] = (concatD [prt 0 x])
  prtList _ (x:xs) = (concatD [prt 0 x, prt 0 xs])
instance Print Arg where
  prt i e = case e of
    Arg id type_ -> prPrec i 0 (concatD [prt 0 id, doc (showString ":"), prt 0 type_])
  prtList _ [] = (concatD [])
  prtList _ [x] = (concatD [prt 0 x])
  prtList _ (x:xs) = (concatD [prt 0 x, doc (showString ","), prt 0 xs])
instance Print ReturnType where
  prt i e = case e of
    ReturnType type_ -> prPrec i 0 (concatD [doc (showString "of"), prt 0 type_])
    EmptyReturnType -> prPrec i 0 (concatD [])
...
instance Print Stmt where
  prt i e = case e of
    Decl id expr -> prPrec i 0 (concatD [doc (showString "let"), prt 0 id, doc (showString "="), prt 0 expr])
...
instance Print Type where
  prt i e = case e of
    ...
    FnType types type_ -> prPrec i 0 (concatD [doc (showString "fn"), doc (showString "("), prt 0 types, doc (showString ")"), doc (showString "of"), prt 0 type_])
...
instance Print Expr where
  prt i e = case e of
    ...
    Cond expr block -> prPrec i 6 (concatD [doc (showString "if"), doc (showString "("), prt 0 expr, doc (showString ")"), prt 0 block])
    CondElse expr block1 block2 -> prPrec i 6 (concatD [doc (showString "if"), doc (showString "("), prt 0 expr, doc (showString ")"), prt 0 block1, doc (showString "else"), prt 0 block2])
    While expr block -> prPrec i 6 (concatD [doc (showString "while"), doc (showString "("), prt 0 expr, doc (showString ")"), prt 0 block])
    BStmt block -> prPrec i 6 (concatD [prt 0 block])
    Closure args expr -> prPrec i 6 (concatD [doc (showString "|"), prt 0 args, doc (showString "|"), prt 0 expr])
